package com.xlyj.wood.game.jigsaw_puzzle;
...
import com.xlyj.wood.game.jigsaw_puzzle.ImagePiece;
import com.xlyj.wood.game.jigsaw_puzzle.ImageSplitterUtil;
...
public class GameView extends RelativeLayout implements View.OnClickListener {
    ...
    private void initBitmap() {
        //判断是否存在这张图片
        if (mBitmap == null) {
            mBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.s_commodity7);
        }
        //进行裁剪
